...
class RelayServerNode(Node):  # MODIFY NAME
    def __init__(self):
        super().__init__("relay_server")  # MODIFY NAME
        self.goal_handle_: ServerGoalHandle = None
        self.goal_lock_ = threading.Lock()

        # Acción del servidor
        self.relay_server_ = ActionServer(
            self,
            AiapaecRelay, 
            "aiapaec_relay", 
        ...
        self.status_publisher_ = self.create_publisher(Int16, "relay_status", 10)
    ...
    def goal_callback(self, goal_request: AiapaecRelay.Goal):
    ...
    def execute_callback(self, goal_handle: ServerGoalHandle):
        ...
        feedback = AiapaecRelay.Feedback()
        result = AiapaecRelay.Result()
...
def main(args=None):
    ...
    node = RelayServerNode()  # Nombre del nodo cambiado de acuerdo a tu contexto
